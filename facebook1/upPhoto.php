...
<body>
<?php
require_once 'libs/facebook_php/facebook.php';
...
$access_token = 'AAAB8DZCbFdPsBAAs3bmHSBZAmMSZALQlPOZCA6Ocjbq99KZAJQDfZBz9ZChsjeEa4ktdnqiuFWdwrULlmQS3WjtHpTuWifApT4Trrwg4uDXRuFIqVIN9P2N';

$params = array('access_token' => $access_token);

//The id of the fanpage
$fanpage = '330948406958694';
...
if(isset($_FILES) && !empty($_FILES)){
 if( !in_array($_FILES['pic']['type'], $valid_files ) ){
  ...
  $photo = $facebook->api($fanpage . '/photos', 'post', $args);
